...
const TESTIMONIALS = [
{
  ...
  quote:
  'CourtBook completely changed how I play tennis. No more calling clubs to check availability. I can book a court in 30 seconds from my phone.',
  rating: 5
},
{
  name: 'Marcus Chen',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-brand-slate max-w-2xl mx-auto">
            Join thousands of athletes who use CourtBook to find and reserve
            their perfect playing space.
          </p>
        </div>
